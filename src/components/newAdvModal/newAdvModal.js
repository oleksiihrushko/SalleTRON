...
<li>
  ...
  document
    .querySelector('.ul-img-lable')
    .insertAdjacentHTML('beforeend', imgMarkup);
  let img;
  ...
  const prodDescriptOff = document.querySelector(
    '.new-adv-modal-form-product-descriptions',
  );
  ...
  const detectImg = e => {
    ...
    listImg.children[downImgNumber + 1].children[1].classList.remove(
      'new-adv-modal-form-diseibl-img',
    );
    listImg.children[downImgNumber + 1].children[1].classList.add(
      'new-adv-modal-form-addimg-plus',
    );
  };
  ...
  const inputDescriptions = document.querySelector(
    '.new-adv-modal-form-product-descriptions',
  );
  const inputCategories = document.querySelector(
    '.new-adv-modal-form-categories',
  );
  ...
  function checkValue(e) {
    ...
    submitBtn.images = [
      ...
      img3.getAttribute('src'),
      img4.getAttribute('src'),
      img5.getAttribute('src'),
